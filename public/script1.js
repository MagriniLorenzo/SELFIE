...
async function saveEvents() {
  try {
    ...
    if (!response.ok) throw new Error("Errore durante il salvataggio degli eventi");
    console.log("Eventi salvati con successo");
  } catch (error) {
    console.error("Errore durante il salvataggio degli eventi:", error);
  }
}
